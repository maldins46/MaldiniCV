...
\smaller{Developed and engineered tools for the Sales department, as part of the RevOps Team. Details to be added.}

\smaller{Stack: React, Spring Boot, MySQL. Technologies: GCP, Hubspot, Salesforce, JUnit, Mockito, gRPC.}\is
