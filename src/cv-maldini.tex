...
\colorbox{cvaccent}{\begin{minipage}[t][5mm][t]{\textwidth}\null\hfill\null\end{minipage}}

\vspace{-.2ex} % Eliminates the small gap
\colorbox{cvaccent!90}{\color{white}  %% LEFT BOX
\kern0.09\textwidth\relax% Left margin provided explicitly
\begin{minipage}[t][272mm][t]{0.82\textwidth}
\raggedright
\vspace*{2.5ex}
...
\null\hfill\includegraphics[width=0.50\textwidth]{profile.jpg}\hfill\null
